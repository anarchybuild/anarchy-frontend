...
function TransactionModalContent(props) {
    ...
    if (screen === "execute-tx") {
        return ((0, jsx_runtime_1.jsx)(ExecutingScreen_js_1.ExecutingTxScreen, { tx: props.tx, closeModal: props.onClose, onTxSent: props.onTxSent, windowAdapter: WindowAdapter_js_1.webWindowAdapter }));
    }
    ...
    return ((0, jsx_runtime_1.jsx)(BridgeOrchestrator_js_1.BridgeOrchestrator, { client: props.client, uiOptions: {
            mode: "transaction",
