...
function WalletRow(props) {
    ...
    const addressOrENS = address
        ...
        : "";
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", style: { justifyContent: "space-between" }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", gap: "md", color: "secondaryText", children: [wallet ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: wallet.id, size: index_js_2.iconSize[props.iconSize || "md"], client: props.client })) : ((0, jsx_runtime_1.jsx)(OutlineWalletIcon_js_1.OutlineWalletIcon, { size: index_js_2.iconSize[props.iconSize || "md"] })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "3xs", children: [props.label ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryText", children: props.label })) : null, (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: props.textSize || "xs", color: "primaryText", style: { fontWeight: 600, fontFamily: "monospace" }, children: addressOrENS || (0, address_js_1.shortenAddress)(props.address) }), profile.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_2.fontSize.sm })) : email || walletInfo?.data?.name ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryText", children: email || walletInfo?.data?.name })) : null] })] }) }));
}
