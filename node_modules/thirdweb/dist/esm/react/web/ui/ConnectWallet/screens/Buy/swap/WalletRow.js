...
export function WalletRow(props) {
    ...
    const addressOrENS = address
        ...
        : "";
    return (_jsx(Container, { flex: "row", style: { justifyContent: "space-between" }, children: _jsxs(Container, { flex: "row", center: "y", gap: "md", color: "secondaryText", children: [wallet ? (_jsx(WalletImage, { id: wallet.id, size: iconSize[props.iconSize || "md"], client: props.client })) : (_jsx(OutlineWalletIcon, { size: iconSize[props.iconSize || "md"] })), _jsxs(Container, { flex: "column", gap: "3xs", children: [props.label ? (_jsx(Text, { size: "xs", color: "secondaryText", children: props.label })) : null, _jsx(Text, { size: props.textSize || "xs", color: "primaryText", style: { fontWeight: 600, fontFamily: "monospace" }, children: addressOrENS || shortenAddress(props.address) }), profile.isLoading ? (_jsx(Skeleton, { width: "100px", height: fontSize.sm })) : email || walletInfo?.data?.name ? (_jsx(Text, { size: "xs", color: "secondaryText", children: email || walletInfo?.data?.name })) : null] })] }) }));
}
